        ...
        <div className="relative px-2 flex h-16 items-center justify-between max-w-full">
          <div className="flex items-center">
            ...
            <Link href="/" className="text-sm font-medium transition-colors">
              <h1 className="text-xl md:text-2xl font-semibold font-mono bg-clip-text text-transparent bg-gradient-to-r from-indigo-700 via-pink-500 to-purple-500 tracking-wide uppercase">
                Zimbini Sweety Sambunjana
              </h1>
            </Link>
          </div>
